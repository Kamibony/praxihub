...
const tableBodyRegex = /<tbody className="bg-white divide-y divide-gray-200">[\s\S]*?<\/tbody>/;
const match = content.match(tableBodyRegex);
...
if (match) {
    ...
    content = content.replace(tableBodyRegex, tbodyContent);
