...
const regex = /<td className="px-6 py-4 whitespace-nowrap">\s*<span\s*className=\{`px-2\.5 py-0\.5 inline-flex text-xs leading-5 font-semibold rounded-full border [\s\S]*?<\/span>\s*<\/td>\s*<td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">/;
