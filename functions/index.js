...
exports.importRoster = functions
  ...
  // Pre-process all unique institutions from the mappedData
  ...
  const processUser = async (userObj) => {
    ...
    try {
      await db.runTransaction(async (transaction) => {
        ...
        // Institutions are already resolved
        ...
        // Legacy orgs collection creation removed in favor of institution users via instMap
